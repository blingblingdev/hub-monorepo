...
CMD ["yarn", "--cwd=apps/hubble", "start", "--rpc-port", "32282", "--ip", "0.0.0.0", "--gossip-port", "32283", "--eth-rpc-url", "https://eth-goerli.g.alchemy.com/v2/KqEbo9pahkUx1oIiLapHK3pWyyEAxmLb", "-b", "/dns/hoyt.farcaster.xyz/tcp/2282", "--network", "1"]
